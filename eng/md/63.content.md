...
* **Associated ACAI Concepts:** Favor (ID: `keyterm:Favor`); Jesus (ID: `person:Jesus.2`); Love (ID: `keyterm:Love`); LORD (ID: `deity:Lord`); Mercy (ID: `keyterm:Mercy`); Truth (ID: `keyterm:Truth`); Make Peace (ID: `keyterm:Peace`)
