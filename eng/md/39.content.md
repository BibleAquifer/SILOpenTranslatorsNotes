...
* **Associated ACAI Concepts:** Love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Edomites (ID: `group:Edom`); Edom (ID: `place:Edom`)
...
* **Associated ACAI Concepts:** Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Gentiles (ID: `group:Gentile`); Offering (ID: `keyterm:Offering`); Pure (ID: `keyterm:Pure`); LORD (ID: `deity:Lord`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Fear (ID: `keyterm:Fear`); To Curse (ID: `keyterm:Curse`); Vow (ID: `keyterm:Vow`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`)
...
* **Associated ACAI Concepts:** Fairness (ID: `keyterm:Fairness`); Instruction (ID: `keyterm:Instruction`); Peace (ID: `keyterm:IntactState`); Truth (ID: `keyterm:Truth`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); Levi (ID: `person:Levi.3`); LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Covenant (ID: `keyterm:Covenant`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); To Dishonor (ID: `keyterm:Dishonor`); Love (ID: `keyterm:Love`); Israel (ID: `person:Israel`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Delight (ID: `keyterm:Delight`); Offering (ID: `keyterm:Offering`); LORD (ID: `deity:Lord`); Stone Altar (ID: `realia:StoneAltar`); Tabernacle Altar (ID: `realia:TabernacleAltar`); Temple Altar (ID: `realia:TempleAltar`); Altar (ID: `realia:Altar`)
...
* **Associated ACAI Concepts:** Tribe of Levi (ID: `group:Levi`); Offering (ID: `keyterm:Offering`); Pure (ID: `keyterm:Pure`); Levi (ID: `person:Levi.3`); LORD (ID: `deity:Lord`); Money (ID: `realia:Money`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Offering (ID: `keyterm:Offering`); Tribe of Judah (ID: `group:Judah`); LORD (ID: `deity:Lord`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); Israel (ID: `person:Israel`); Decree (ID: `keyterm:Decree`); Instruction (ID: `keyterm:Instruction`); Mount Sinai (ID: `place:SinaiMount`)
