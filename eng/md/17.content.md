...
* **Associated ACAI Concepts:** Cotton (ID: `flora:Cotton`); Bed (ID: `realia:Bed`); Rope (ID: `realia:Rope`); Linen (ID: `realia:Linen`); Money (ID: `realia:Money`); Purple Cloth (ID: `realia:PurpleCloth`)
...
* **Associated ACAI Concepts:** Zethar (ID: `person:Zethar`); Biztha (ID: `person:Biztha`); Mehuman (ID: `person:Mehuman`); Harbona (ID: `person:Harbona`); Bigtha (ID: `person:Bigtha`); Abagtha (ID: `person:Abagtha`); Carkas (ID: `person:Carkas`); Ahasuerus (ID: `person:Ahasuerus`); Vine (ID: `flora:Vine`); Wine (ID: `realia:Wine`)
...
* **Associated ACAI Concepts:** Marsena (ID: `person:Marsena`); Carshena (ID: `person:Carshena`); Meres (ID: `person:Meres`); Admatha (ID: `person:Admatha`); Shethar (ID: `person:Shethar`); Memucan (ID: `person:Memucan`); Media (ID: `place:Media`); Persia (ID: `place:Persia`); Tarshish (ID: `place:Tarshish`)
...
* **Associated ACAI Concepts:** Vashti (ID: `person:Vashti`); Ahasuerus (ID: `person:Ahasuerus`); Persia (ID: `place:Persia`); Medes (ID: `group:Mede`); Medan (ID: `person:Medan`); Persians (ID: `group:Persia`)
...
* **Associated ACAI Concepts:** Mordecai (ID: `person:Mordecai.2`); Shimei (ID: `person:Shimei.18`); Jair (ID: `person:Jair.4`); Kish (ID: `person:Kish.4`); Susa (ID: `place:Susa`); Benjamin (ID: `person:Benjamin`); Tribe of Benjamin (ID: `group:Benjamin`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Nebuchadnezzar (ID: `person:Nebuchadnezzar`); Tribe of Judah (ID: `group:Judah`); Jehoiachin (ID: `person:Jehoiachin`); Jerusalem (ID: `place:Jerusalem`); Babylon (ID: `place:Babylon`)
...
* **Associated ACAI Concepts:** Haman (ID: `person:Haman`); Hammedatha (ID: `person:Hammedatha`); Agag (ID: `person:Agag.2`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); To Beg for Mercy (ID: `keyterm:BegForMercy`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Favor (ID: `keyterm:Favor`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Scroll (ID: `realia:Scroll`)
...
* **Associated ACAI Concepts:** Esther (ID: `person:Esther`); Haman (ID: `person:Haman`); Jews (ID: `group:Jews`); Susa (ID: `place:Susa`)
...
* **Associated ACAI Concepts:** Hammedatha (ID: `person:Hammedatha`); Lot (ID: `keyterm:Lot`); Agag (ID: `person:Agag.2`); Haman (ID: `person:Haman`); Agagites (ID: `group:Agag`); Jews (ID: `group:Jews`); Lot (ID: `realia:Lot`)
...
* **Associated ACAI Concepts:** Abihail (ID: `person:Abihail.5`); Mordecai (ID: `person:Mordecai.2`); Esther (ID: `person:Esther`); Jews (ID: `group:Jews`)
