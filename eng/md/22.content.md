...
* **Associated ACAI Concepts:** Solomon (ID: `person:Solomon`); Kedar (ID: `person:Kedar`); Jerusalem (ID: `place:Jerusalem`); Linen Strips (ID: `realia:LinenStrips`); Tent (ID: `realia:Tent`); Goat Hair Strips (ID: `realia:GoatHairStrips`)
...
* **Associated ACAI Concepts:** Beam (ID: `realia:Beam`); Cypress (ID: `flora:Cypress`); Phoenician Juniper (ID: `flora:JuniperTree`); House (ID: `realia:House`); Grecian Juniper (ID: `flora:Juniper`); Fir (ID: `flora:Fir`); Cedar (ID: `flora:Cedar`)
...
* **Associated ACAI Concepts:** Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Balsam Tree (ID: `flora:BalsamTree`)
...
* **Associated ACAI Concepts:** Saffron Plant (ID: `flora:SaffronPlant`); Calamus (ID: `flora:Calamus`); Frankincense (ID: `flora:Frankincense`); Myrrh (ID: `flora:Myrrh`); Cinnamon (ID: `flora:Cinnamon`); Balsam Tree (ID: `flora:BalsamTree`); Agarwood (ID: `flora:Agarwood`); Nard (ID: `flora:Nard`)
