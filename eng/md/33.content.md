...
* **Associated ACAI Concepts:** Moresheth (ID: `place:Moresheth`); Micah (ID: `person:Micah.6`); Judah (ID: `person:Judah.4`); Word of the Lord (ID: `keyterm:WordOfTheLord`); Tribe of Judah (ID: `group:Judah`); Hezekiah (ID: `person:Hezekiah`); Have a Vision (ID: `keyterm:HaveAVision`); LORD (ID: `deity:Lord`); Jotham (ID: `person:Jotham.2`); Ahaz (ID: `person:Ahaz`); Samaria (ID: `place:Samaria`); Jerusalem (ID: `place:Jerusalem`)
...
* **Associated ACAI Concepts:** Judah (ID: `person:Judah.4`); Israel (ID: `person:Israel`); Tribe of Judah (ID: `group:Judah`); Rebel (ID: `keyterm:Rebel`); Samaria (ID: `place:Samaria`); To Sin (ID: `keyterm:Sin`); Jerusalem (ID: `place:Jerusalem`); Stone Pine (ID: `flora:Pine`); High Place (ID: `realia:HighPlace`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Lachish (ID: `place:Lachish`); Rebel (ID: `keyterm:Rebel`); To Sin (ID: `keyterm:Sin`); Jerusalem (ID: `place:Jerusalem`); Chariot (ID: `realia:Chariot`); Horse (ID: `fauna:Horse`)
...
* **Associated ACAI Concepts:** Adullam (ID: `place:Adullam`); Dispossess (ID: `keyterm:Dispossess`); Glory (ID: `keyterm:Glory`); Israel (ID: `person:Israel`); Mareshah (ID: `place:Mareshah`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); To Sin (ID: `keyterm:Sin`); Strength (ID: `keyterm:Strength`)
...
* **Associated ACAI Concepts:** Word of the Lord (ID: `keyterm:WordOfTheLord`); Israel (ID: `person:Israel`); The Way (ID: `keyterm:TheWay`); LORD (ID: `deity:Lord`); Instruction (ID: `keyterm:Instruction`); Jerusalem (ID: `place:Jerusalem`); House (ID: `realia:House`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Set Apart for God (ID: `keyterm:Proscribe`); Horn (ID: `keyterm:Horn`); Jerusalem (ID: `place:Jerusalem`); Sheep (ID: `fauna:Lamb`)
...
* **Associated ACAI Concepts:** Israel (ID: `person:Israel`); Bethlehem (ID: `place:Bethlehem`); Judah (ID: `person:Judah.4`); Tribe of Judah (ID: `group:Judah`)
...
* **Associated ACAI Concepts:** Moses (ID: `person:Moses`); Egypt (ID: `place:Egypt`); Miriam (ID: `person:Miriam`); Aaron (ID: `person:Aaron`); Redeem (ID: `keyterm:Redeem`)
...
* **Associated ACAI Concepts:** Balak (ID: `person:Balak`); Shittim (ID: `place:Shittim`); LORD (ID: `deity:Lord`); Beor (ID: `person:Beor.2`); Gilgal (ID: `place:Gilgal.2`); Moab (ID: `place:Moab`); Balaam (ID: `person:Balaam`)
...
* **Associated ACAI Concepts:** LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); To Sin (ID: `keyterm:Sin`); Anointing Oil (ID: `realia:AnointingOil`); Sheep (ID: `fauna:Lamb`); Olive Oil (ID: `realia:OliveOil`)
...
* **Associated ACAI Concepts:** Mule (ID: `fauna:Mule`); Vine (ID: `flora:Vine`); Anointing Oil (ID: `realia:AnointingOil`); Barley (ID: `flora:Barley`); Olive Oil (ID: `realia:OliveOil`); Wine (ID: `realia:Wine`); Must (ID: `realia:Must`); Olive Tree (ID: `flora:OliveTree`)
...
* **Associated ACAI Concepts:** Euphrates River (ID: `place:Euphrates`); Egypt (ID: `place:Egypt`); Assyria (ID: `place:Assyria`)
...
* **Associated ACAI Concepts:** Bashan (ID: `place:Bashan`); Gilead (ID: `place:Gilead`); To Cause to Possess (ID: `keyterm:Possess`); Staff (ID: `realia:Staff`); Sandalwood (ID: `flora:Sandalwood`); Sheep (ID: `fauna:Lamb`); Flock (ID: `fauna:Flock`); Goat (ID: `fauna:Goat`); Rod (ID: `realia:Rod`)
...
* **Associated ACAI Concepts:** Kindness (ID: `keyterm:Kindness`); To Cause to Possess (ID: `keyterm:Possess`); LORD (ID: `deity:Lord`); Rebel (ID: `keyterm:Rebel`); Forgive (ID: `keyterm:Forgive`); Passion (ID: `keyterm:Ardour`)
...
* **Associated ACAI Concepts:** Abraham (ID: `person:Abraham`); Israel (ID: `person:Israel`); Kindness (ID: `keyterm:Kindness`); Truth (ID: `keyterm:Truth`); Swear (ID: `keyterm:Swear`)
